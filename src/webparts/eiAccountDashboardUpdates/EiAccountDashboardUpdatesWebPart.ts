...
import * as strings from 'EiAccountDashboardUpdatesWebPartStrings';
import EiAccountDashboardUpdates from './components/EiAccountDashboardUpdates';
import { IEiAccountDashboardUpdatesProps } from './components/IEiAccountDashboardUpdatesProps';
import { getWebPartSP } from '../../services/pnpjsConfig';
import { IDynamicDataCallables, IDynamicDataPropertyDefinition } from '@microsoft/sp-dynamic-data';
import { SharedService } from '../../services/SharedService';

export interface IEiAccountDashboardUpdatesWebPartProps {
  description: string;
  event: DynamicProperty<any>;
  context: WebPartContext;
}

export default class EiAccountDashboardUpdatesWebPart extends BaseClientSideWebPart<IEiAccountDashboardUpdatesWebPartProps> implements IDynamicDataCallables {
...
*/
  ...
  public render(): void {
    ...
    const element: React.ReactElement<IEiAccountDashboardUpdatesProps> = React.createElement(
      EiAccountDashboardUpdates,
      {

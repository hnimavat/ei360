...
import * as strings from 'EngagementDashboardTileWebPartStrings';
import EngagementDashboardTile from './components/EngagementDashboardTile';
import { IEngagementDashboardTileProps } from './components/IEngagementDashboardTileProps';
import { IDynamicDataCallables, IDynamicDataPropertyDefinition } from '@microsoft/sp-dynamic-data';
import { getWebPartSP } from '../../services/pnpjsConfig';
import { SharedService } from '../../services/SharedService';

export interface IEngagementDashboardTileWebPartProps {
  description: string;
  event: DynamicProperty<any>;
  context: WebPartContext;
}

export default class EngagementDashboardTileWebPart extends BaseClientSideWebPart<IEngagementDashboardTileWebPartProps> implements IDynamicDataCallables {
...
*/
  ...
  public render(): void {
    ...
    const element: React.ReactElement<IEngagementDashboardTileProps> = React.createElement(
      EngagementDashboardTile,
      {

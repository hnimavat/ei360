...
import type { IAccountDashboardMsaOverdueProps } from './IAccountDashboardMsaOverdueProps';
...
export interface IAccountDashboardMsaOverdueState {
  showPopup: boolean;
  value: any
}

export default class EiAccountsTilesDetails extends React.Component<IAccountDashboardMsaOverdueProps, IAccountDashboardMsaOverdueState, {}> {
  
  constructor(props: IAccountDashboardMsaOverdueProps) {
    super(props);
  ...
  public render(): React.ReactElement<IAccountDashboardMsaOverdueProps> {
      ...
      <section className="accountOverviewSection ">
        ...
        <div className='datatable-wrapper'> 
          ...
          <Column selectionMode="multiple" style={{ minWidth: '50px' }} align='center'></Column>
            <Column field="duedays" header="Overdue Days" filter style={{ minWidth: '150px' }} align='right'></Column>
